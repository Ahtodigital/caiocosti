...
<p>This plugin is designed to compliment, not replace, either the "<a href="https://wordpress.org/plugins/wordpress-seo/" target="_blank" rel="nofollow">Yoast Wordpress SEO</a>" plugin or the "<a href="http://wordpress.org/extend/plugins/all-in-one-seo-pack/" target="_blank" rel="nofollow">All in One SEO pack</a>". This plugin completes tasks that they do not, and there is no conflict.</p>
<p>You should have no other plugins active while running the SEO Automatic Core Tweaks process. To see a short video of how to use this plugin, <a href="http://www.seoautomatic.com/plugins/wp-core-tweaks/" target="_blank">click here</a> and if you need support, please send an email by clicking <a href="mailto:scott@searchcommander.com?cc=heather@searchcommander.com&subject=Core%20Tweaks%20Support">here</a>.</p>
<p>
<b>READ ME FIRST:</b>
